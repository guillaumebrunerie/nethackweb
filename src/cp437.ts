// Adapted from https://www.unicode.org/Public/MAPPINGS/VENDORS/MICSFT/PC/CP437.TXT

export const decodeCP437 = (char: string) => {
	const code = char.charCodeAt(0) as keyof typeof cp437Table;
	return String.fromCodePoint(cp437Table[code]);
};
